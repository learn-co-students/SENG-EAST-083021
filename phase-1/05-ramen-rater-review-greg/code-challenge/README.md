...
- After clicking on a single ramen how do we get ALL detail single card
- non inner HTML approach
- iterating the first object?
- implementing more recent concepts
